import uuid
import enum
from sqlalchemy import Column, String, Integer, Boolean, DateTime, Enum, Text, LargeBinary
...
class Tournament(Base):
    ...
    logo_data = Column(LargeBinary, nullable=True)  # Stocke l'image en binaire
    logo_content_type = Column(String(50), nullable=True)  # Type MIME de l'image
